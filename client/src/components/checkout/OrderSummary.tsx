...
export function OrderSummary({
  ...
  return <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <button type="submit" form="delivery-form" className="w-full mt-6 bg-amber-500 hover:bg-amber-600 text-white py-3 rounded-full font-medium transition-colors">
        Confirmar Pedido
      </button>
    </div>;
}